    ...
    >
      <div className="bg-black border border-gray-800 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-800 sticky top-0 bg-black">
          <h2 className="text-2xl font-bold text-[#C0C0C0]">{t("help.aboutTitle")}</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6 text-[#C0C0C0]">
          ...
          <div className="grid gap-4">
            <div className="bg-gray-900/30 p-4 rounded-lg border border-gray-800">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-semibold text-white">{t("help.developer")}</h4>
              </div>
              <p className="text-[#C0C0C0] font-medium">Rafael Rodríguez Mengual</p>
            </div>

            <div className="bg-gray-900/30 p-4 rounded-lg border border-gray-800">
              <div className="flex items-center gap-3 mb-2">
                <School className="text-[#C0C0C0]" size={20} />
                <h4 className="font-semibold text-white">{t("help.institute")}</h4>
              </div>
            ...
            <div className="bg-gray-900/30 p-4 rounded-lg border border-gray-800">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-semibold text-white">{t("help.developmentYear")}</h4>
              </div>
            ...
            <div className="bg-gray-900/30 p-4 rounded-lg border border-gray-800">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-semibold text-white">{t("help.technologies")}</h4>
              </div>
          ...
          <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700">
            <h4 className="font-semibold text-white mb-2">{t("help.projectDescription")}</h4>
            <p className="text-gray-300 text-sm leading-relaxed">{t("help.projectDescriptionText")}</p>
          </div>

          <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700">
            <h4 className="font-semibold text-white mb-2">{t("help.features")}</h4>
