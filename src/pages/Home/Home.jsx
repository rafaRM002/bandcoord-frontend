...
function PublicHome() {
  return (
    <div className="w-full bg-black">
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#C0C0C0] mb-6">
            Bienvenido a
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#C0C0C0] to-white">
              {" "}
              BandCoord
            </span>
          </h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-10">
            La plataforma integral para gestionar todos los aspectos de tu banda
            musical
          </p>
      ...
      {/* Features section */}
      <section className="py-16 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold text-[#C0C0C0] mb-12 text-center">
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-black/30">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#C0C0C0] mb-6">
                Sobre BandCoord
              </h2>
              <p className="text-gray-400 mb-6">
                BandCoord nació de la necesidad de simplificar la gestión de
                bandas musicales. Nuestra plataforma ofrece herramientas
                intuitivas para coordinar eventos, gestionar partituras,
                facilitar la comunicación entre miembros y mucho más.
              </p>
              <p className="text-gray-400 mb-6">
                Diseñada por músicos para músicos, BandCoord entiende las
                necesidades específicas de las bandas y proporciona soluciones
                adaptadas a cada tipo de agrupación musical.
              </p>
              ...
              <div className="bg-black rounded-lg p-8 h-full">
                ...
                <ul className="space-y-4">
                  <li className="flex gap-3">
                    ...
                    <div>
                      <h4 className="text-[#C0C0C0] font-medium">
                        Todo en un solo lugar
                      </h4>
                      <p className="text-gray-400 text-sm">
                        Gestiona todos los aspectos de tu banda desde una única
                        plataforma.
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Interfaz intuitiva diseñada para músicos, no para
                        programadores.
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Trabaja con tu banda de forma sincronizada y eficiente.
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Asistencia dedicada para resolver cualquier duda o
                        problema.
                      </p>
                    </div>
                  </li>
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-black/50 p-8 rounded-lg border border-gray-800 hover:border-[#C0C0C0] transition-colors duration-300">
            ...
            <h3 className="text-xl font-semibold text-[#C0C0C0] text-center mb-4">
              Regístrate
            </h3>
            <p className="text-gray-400 text-center">
              Crea tu cuenta y configura el perfil de tu banda con todos los
              detalles necesarios.
            </p>
          </div>
          <div className="bg-black/50 p-8 rounded-lg border border-gray-800 hover:border-[#C0C0C0] transition-colors duration-300">
            ...
            <p className="text-gray-400 text-center">
              Añade a los miembros de tu banda para que puedan acceder a toda la
              información.
            </p>
          </div>
          <div className="bg-black/50 p-8 rounded-lg border border-gray-800 hover:border-[#C0C0C0] transition-colors duration-300">
            ...
            <h3 className="text-xl font-semibold text-[#C0C0C0] text-center mb-4">
              ¡Comienza a coordinar!
            </h3>
            <p className="text-gray-400 text-center">
              Gestiona eventos, composiciones, comunicaciones y más desde un
              solo lugar.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-black/50">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-[#C0C0C0] mb-6">
            ¿Listo para empezar?
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto mb-8">
            Únete a BandCoord hoy y lleva la gestión de tu banda al siguiente
            nivel. Regístrate gratis y descubre todas las herramientas que
            tenemos para ti.
          </p>
          <Link
            to="/register"
  ...
  return (
    <div className="w-full bg-black">
      ...
      <section className="py-10 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-gradient-to-l from-gray-900 to-black p-6 rounded-lg border border-gray-800">
          ...
          <p className="text-gray-400">
            Accede a todas las funcionalidades de BandCoord desde tu panel de
            control.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        <h2 className="text-xl font-semibold text-[#C0C0C0] mb-6">
          Accesos rápidos
        </h2>
      ...
      <section className="py-8 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link
            to="/eventos"
            className="text-sm text-[#C0C0C0] hover:text-white"
          >
            Ver todos →
          </Link>
        </div>
      ...
      <section className="py-8 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="bg-black/50 border border-gray-800 rounded-lg overflow-hidden">
          <div className="p-4 border-b border-gray-800">
            <p className="text-gray-400 text-sm">
              No hay composiciones recientes.
            </p>
          </div>
        </div>
      </section>
...
function FeatureCard({ icon, title, description }) {
  return (
    <div className="bg-black/50 p-6 rounded-lg border border-gray-800 hover:border-[#C0C0C0] transition-colors duration-300 h-full">
      ...
      <h3 className="text-xl font-semibold text-[#C0C0C0] text-center mb-2">
        {title}
      </h3>
